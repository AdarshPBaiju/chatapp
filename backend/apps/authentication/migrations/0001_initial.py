    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["jti", "expires_at"], name="authenticat_jti_90d109_idx"
                    )
                ],
            },
        ),
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="authenticat_user_id_9bc38a_idx",
                    ),
                    models.Index(
                        fields=["user", "expires_at"],
                        name="authenticat_user_id_1f6ded_idx",
                    ),
                    models.Index(
                        fields=["session_id", "user"],
                        name="authenticat_session_b1c0fe_idx",
                    ),
                    models.Index(
                        fields=["access_jti", "user"],
                        name="authenticat_access__216884_idx",
                    ),
                ],
            },
        ),
