...
from authentication.recovery.infrastructure.serializers import (
...
class ClientPasswordResetVerifyAPIView(APIView):
    ...
    def post(self, request):
        ...
        reset_token = RecoveryService.verify_password_reset_otp(
...
class ClientPasswordResetConfirmAPIView(APIView):
    ...
    def post(self, request):
        ...
        is_reset = RecoveryService.reset_password(
...
class ClientPasswordChangeAPIView(APIView):
    ...
    def post(self, request):
        ...
        revoked_count = SessionManager.revoke_all_sessions(
            str(user.id),
